...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1543190787023607833)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1543191698021629909)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1543192299883639964)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(619747586130865263)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277654332057184042)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277648390704182532)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277591874595781302)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277580484073776367)
,p_plugin_attribute_id=>wwv_flow_api.id(277591874595781302)
,p_display_sequence=>10
,p_display_value=>'Spinner'
,p_return_value=>'spinner'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277580154169774484)
,p_plugin_attribute_id=>wwv_flow_api.id(277591874595781302)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277579702764739953)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(277591874595781302)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277538653308583138)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277532748937572399)
,p_plugin_attribute_id=>wwv_flow_api.id(277538653308583138)
,p_display_sequence=>10
,p_display_value=>'From Page Item'
,p_return_value=>'pageitem'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277532275380567975)
,p_plugin_attribute_id=>wwv_flow_api.id(277538653308583138)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277526432677503223)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(277538653308583138)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277520522213498504)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277508844239492270)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277502878419489084)
,p_plugin_attribute_id=>wwv_flow_api.id(277508844239492270)
,p_display_sequence=>10
,p_display_value=>'Into Page Item'
,p_return_value=>'pageitem'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277502512612483423)
,p_plugin_attribute_id=>wwv_flow_api.id(277508844239492270)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277502098491481521)
,p_plugin_attribute_id=>wwv_flow_api.id(277508844239492270)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277501707944474313)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
,p_is_required=>true
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(277508844239492270)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'pageitem'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277495833083468471)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(277700152332065526)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277694616122062881)
,p_plugin_attribute_id=>wwv_flow_api.id(277700152332065526)
,p_display_sequence=>10
,p_display_value=>'Suppress Change Event'
,p_return_value=>'suppressChangeEvent'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(277689089679048450)
,p_plugin_attribute_id=>wwv_flow_api.id(277700152332065526)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(277386989410659484)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(271954191907343851)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(271953792921343869)
,p_plugin_id=>wwv_flow_api.id(1543190787023607833)
